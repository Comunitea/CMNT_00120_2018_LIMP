...
class AcceptanceDocument(models.Model):
    ...
    line_ids = fields.One2many("acceptance.document.line", "acceptance_id",
                               "Wastes")
...
class AcceptanceDocumentLine(models.Model):

    _name = "acceptance.document.line"

    acceptance_id = fields.Many2one("acceptance.document", "Doc")
