...
class analytic_account_employees(models.Model):
    ...
    analytic_id = fields.Many2one(
        "account.analytic.account", "Analytic", readonly=True
    )
...
class AccountAnalyticAccount(models.Model):
    ...
    active_employee_ids = fields.One2many(
        "timesheet",
        "analytic_id",
        "Active timesheets",
        domain=[("old", "=", False)],
    ...
    inactive_employee_ids = fields.One2many(
        "timesheet",
        "analytic_id",
        "Unactive timesheets",
        domain=[("old", "=", True)],
    ...
    report_employee_ids = fields.One2many(
        "analytic.account.employees",
        "analytic_id",
        string="Timesheet",
        readonly=True,
        copy=False,
