...
class LegionellaSamples(models.Model):
    ...
    type_product = fields.Selection(
        [
            ...
            ("cold_w_dis_termpoint", "Cold water distant terminal point"),
    ...
    certificate_no = fields.Char(
        "Certificate no", related="picking_id.n_cert", readonly=True
    )
