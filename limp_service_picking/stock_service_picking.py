...
class stock_service_picking(osv.osv):
    ...
    _columns = {
        ...
        'manager_address_id': fields.many2one('res.partner.address', 'Address', help="Destination address", states={'closed':[('readonly',True)],'cancelled':[('readonly',True)]}),
        ...
        'container_situation_id': fields.related('container_id', 'situation_id', relation='res.partner.address', readonly=True, type="many2one", string="Container situation"),
        ...
        'building_site_address_id': fields.many2one('res.partner.address', 'Building site address', states={'cancelled':[('readonly',True)]}),
