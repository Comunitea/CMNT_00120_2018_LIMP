    ...
    def generate_xlsx_report(self, workbook, data, objs):
        ...
        for department in departments:
            ...
            for month in months:
                ...
                expense_amount = sum(self.env['account.analytic.line'].search(
                    filter_domain + [('amount', '<', 0)]).mapped('amount'))
                income_amount = sum(self.env['account.analytic.line'].search(
                    filter_domain + [('amount', '>', 0)]).mapped('amount'))
