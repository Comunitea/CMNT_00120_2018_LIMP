...
class LimpContractManualDDD(models.Model):
    ...
    periodicity_legionella = fields.Selection([('mensual', 'Mensual'), ('bimensual', 'Bimensual'), ('trimestral', 'Trimestral'),
                            ('cuatrimestral', 'Cuatrimestral'), ('bianual', 'Bianual'), ('anual', 'Anual')], string="Periodicity legionella")
